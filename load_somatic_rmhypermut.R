...
### MAIN ###
somaticDriver299_f = "../../Huang_lab_data/TCGA_PanCanAtlas_2018/somatic/Driver_BaileyCell2018/299driverGene.txt"
...
#remove hypermutator samples
#hyper<-fread("../../Huang_lab_data/TCGA_PanCanAtlas_2018/somatic/Driver_BaileyCell2018/HypermutatorSamples.txt")
#somatic<-somatic[-which(somatic$bcr_patient_barcode%in%hyper$TCGA_Barcode),]
#remove hypermutator samples Aug 25, 2019
hyper<-as.character(read.table("../../Huang_lab_data/TCGA_PanCanAtlas_2018/somatic/Driver_BaileyCell2018/HypermutatorSamples.txt",h=T,sep="\t",stringsAsFactors=FALSE)[,1])
somatic<-somatic[-which(somatic$bcr_patient_barcode%in%hyper),]

#hypermutator contributed 43.03546% somatic mutation
...
likelyFunctionalTypes = c("Frame_Shift_Del","Frame_Shift_Ins","In_Frame_Del","In_Frame_Ins","Missense_Mutation","Nonsense_Mutation","Splice_Site","Translation_Start_Site")
somatic_likelyfunctional = somatic[somatic$Hugo_Symbol %in% somaticDriver299 & somatic$Variant_Classification %in% likelyFunctionalTypes,]

# driver mutation
driver_f = "../../Huang_lab_data/TCGA_PanCanAtlas_2018/somatic/Driver_BaileyCell2018/Mutation.CTAT.3D.Scores.txt.gz"
...
driver_func = driver[driver$numOfEvidence > 0,]
somatic_likelyfunctional_driver_loose = somatic_likelyfunctional[somatic_likelyfunctional$Variant_Classification != "Missense_Mutation" | paste(somatic_likelyfunctional$Hugo_Symbol,somatic_likelyfunctional$HGVSp_Short) %in% paste(driver_func$gene,driver_func$protein_change),]
